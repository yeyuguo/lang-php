...
$alang = array (
	'switch_lang_en-us'          => 'United States (English)',
	'switch_lang_zh-cn'          => '简体中文 (中国)',
	'switch_lang_zh-tw'          => '繁體中文 (中國)',
	'lang_page_title'            => '讀取配置文件 & 加載式演示 v2.0',
	'lang_demo_title'            => '讀取配置文件 & 加載式演示',
	'lang_available'             => '可用語言：',
	'lang_note'                  => '模式 1：URL 后缀显示参数；<br/>模式 2：通過 javascript 完全隱藏參數。',
	'lang_mode_a'                => '模式 1',
	'lang_mode_b'                => '模式 2',
	'feature-readme'             => '自動搜索匹配的語言文件並加載後調用，<br />包括：字串符、參數等。<br /><br />',
);
?>